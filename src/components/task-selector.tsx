      ...
      {tasks.length > 1 && (
        <div className="flex items-center gap-2">
          ...
          {path !== "/" && (
            <Label
              htmlFor="checkbox"
              className="text-xs sm:text-base border border-input bg-background hover:bg-accent hover:text-accent-foreground w-fit px-2 py-1 rounded-2xl flex items-center gap-1 cursor-pointer whitespace-nowrap"
            >
              select all
            </Label>
          )}
